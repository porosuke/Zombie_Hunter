    ...
    public partial class Main : Form
    {
        ...
        private void AddObject()
        {
            ...
            Rectangle[] rect1 =
            {
                ...
                new Rectangle(300,50,50,300),
                new Rectangle(150,250,50,100),
                new Rectangle(300,250,50,100),
                new Rectangle(600,150,50,200),
                new Rectangle(800,150,50,200),
                new Rectangle(150,350,350,50),
            };
            Rectangle[] rect2 =
            {
                new Rectangle(0,0,ClientRectangle.Width,Wall),
